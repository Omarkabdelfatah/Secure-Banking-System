...
public class BankStatement {
    ...
    private static final String FILE = "F:\\Secure-Banking-System\\Secure-Banking-System\\FILES\\Statement.pdf";
...
//        trans.getCreatedAt().isEqual(start);
//        System.out.println("The return of getCreatedAt(): "+trans);

        LocalDate start = LocalDate.parse(startDate, DateTimeFormatter.ISO_DATE);
        System.out.println("Date Format: "+start);
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("Secure Banking System"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.BLUE);
        bankName.setPadding(20f);

        PdfPCell bankAddress = new PdfPCell(new Phrase("72, Some Address , EGYPT"));
